...
def prose(s):
    ...
    for p in s.strip().split('\n\n'):
        if 'Continue your Revival application → [APPLICATION_URL]' in p:
            blocks.append('<p><a class="email-cta" href="../application-preview.html" target="_blank" rel="noopener">Continue your Revival application →</a></p>')
...
<section id="sources"><div class="section-heading"><div><span class="eyebrow">06 / ACCURACY</span><h2>Source notes</h2></div><a class="text-link" href="downloads/source-checks.md" download>Download source checks ↓</a></div><div class="source-grid"><article><h3>Program details</h3><p>The three-day format, audience, Christ-centered approach and four pillars are grounded in the supplied Revival brief and <a href="https://rukministries.com/" target="_blank" rel="noopener">RUK Ministries website</a>.</p></article><article><h3>Pastor quotation</h3><p>The page carries three attributed pastor accounts from the Ministries website. E04 now uses a fuller excerpt of Rob Satterfield’s Revival account. No general Google rating or review count is presented as Revival-specific proof.</p></article><article><h3>Opt-in first</h3><p>The form follows the live KSP funnel’s name, email and phone pattern. Revival will then send visitors to the application. The current flow is a preview; final destinations and lead routing are pending.</p></article><article><h3>Campaign scope</h3><p>Pricing is omitted throughout this pack. Event dates are left for the team to confirm during the application process. No invented participant stories or results are included.</p></article></div></section>
